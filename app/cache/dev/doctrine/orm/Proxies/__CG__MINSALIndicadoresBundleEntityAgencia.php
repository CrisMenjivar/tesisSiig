 ...
 */
class Agencia extends \MINSAL\IndicadoresBundle\Entity\Agencia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Agencia' . "\0" . 'id', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Agencia' . "\0" . 'codigo', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\Agencia' . "\0" . 'nombre');
        }
