 ...
 */
class ResponsableDato extends \MINSAL\IndicadoresBundle\Entity\ResponsableDato implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ResponsableDato' . "\0" . 'id', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ResponsableDato' . "\0" . 'establecimiento', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ResponsableDato' . "\0" . 'contacto', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ResponsableDato' . "\0" . 'correo', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ResponsableDato' . "\0" . 'telefono', '' . "\0" . 'MINSAL\\IndicadoresBundle\\Entity\\ResponsableDato' . "\0" . 'cargo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ResponsableDato $proxy) {
