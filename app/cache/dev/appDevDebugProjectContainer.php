...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'indicadores.cargar_origen_datos_servicio' => 'getIndicadores_CargarOrigenDatosServicioService',
            'indicadores.guardar_registro_origen_dato' => 'getIndicadores_GuardarRegistroOrigenDatoService',
            ...
            'monolog.handler.vitacora.siig' => 'getMonolog_Handler_Vitacora_SiigService',
            ...
            'monolog.processor.siig' => 'getMonolog_Processor_SiigService',
            'my_listener' => 'getMyListenerService',
            'old_sound_rabbit_mq.cargar_origen_datos_consumer' => 'getOldSoundRabbitMq_CargarOrigenDatosConsumerService',
            'old_sound_rabbit_mq.cargar_origen_datos_producer' => 'getOldSoundRabbitMq_CargarOrigenDatosProducerService',
            'old_sound_rabbit_mq.connection.default' => 'getOldSoundRabbitMq_Connection_DefaultService',
            'old_sound_rabbit_mq.guardar_registro_consumer' => 'getOldSoundRabbitMq_GuardarRegistroConsumerService',
            'old_sound_rabbit_mq.guardar_registro_producer' => 'getOldSoundRabbitMq_GuardarRegistroProducerService',
            ...
            'sonata.admin.agencia' => 'getSonata_Admin_AgenciaService',
            ...
            'sonata.admin.campo_calculado' => 'getSonata_Admin_CampoCalculadoService',
            'sonata.admin.categoria_variable_captura' => 'getSonata_Admin_CategoriaVariableCapturaService',
            'sonata.admin.clasificacion_nivel' => 'getSonata_Admin_ClasificacionNivelService',
            'sonata.admin.clasificacion_privacidad' => 'getSonata_Admin_ClasificacionPrivacidadService',
            'sonata.admin.clasificacion_tecnica' => 'getSonata_Admin_ClasificacionTecnicaService',
            'sonata.admin.clasificacion_uso' => 'getSonata_Admin_ClasificacionUsoService',
            'sonata.admin.colores_alertas' => 'getSonata_Admin_ColoresAlertasService',
            ...
            'sonata.admin.diccionario' => 'getSonata_Admin_DiccionarioService',
            ...
            'sonata.admin.ficha' => 'getSonata_Admin_FichaService',
            ...
            'sonata.admin.formulario' => 'getSonata_Admin_FormularioService',
            'sonata.admin.fuente_dato' => 'getSonata_Admin_FuenteDatoService',
            ...
            'sonata.admin.imagen' => 'getSonata_Admin_ImagenService',
            'sonata.admin.indicador_alertas' => 'getSonata_Admin_IndicadorAlertasService',
            ...
            'sonata.admin.origen_dato' => 'getSonata_Admin_OrigenDatoService',
            ...
            'sonata.admin.regla_transformacion' => 'getSonata_Admin_ReglaTransformacionService',
            'sonata.admin.responsable_dato' => 'getSonata_Admin_ResponsableDatoService',
            'sonata.admin.responsable_indicador' => 'getSonata_Admin_ResponsableIndicadorService',
            ...
            'sonata.admin.sala_acciones' => 'getSonata_Admin_SalaAccionesService',
            ...
            'sonata.admin.significado_campo' => 'getSonata_Admin_SignificadoCampoService',
            ...
            'sonata.admin.variable' => 'getSonata_Admin_VariableService',
            'sonata.admin.variable_captura' => 'getSonata_Admin_VariableCapturaService',
            ...
            'sonata.costos.admin.alineacion' => 'getSonata_Costos_Admin_AlineacionService',
            'sonata.costos.admin.campo' => 'getSonata_Costos_Admin_CampoService',
            'sonata.costos.admin.categorias_contratos' => 'getSonata_Costos_Admin_CategoriasContratosService',
            'sonata.costos.admin.contratos_fijos' => 'getSonata_Costos_Admin_ContratosFijosService',
            'sonata.costos.admin.criterios_distribucion' => 'getSonata_Costos_Admin_CriteriosDistribucionService',
            'sonata.costos.admin.especialidad' => 'getSonata_Costos_Admin_EspecialidadService',
            'sonata.costos.admin.estructura' => 'getSonata_Costos_Admin_EstructuraService',
            'sonata.costos.admin.formato' => 'getSonata_Costos_Admin_FormatoService',
            'sonata.costos.admin.grupocolumnas' => 'getSonata_Costos_Admin_GrupocolumnasService',
            'sonata.costos.admin.tipo_contratacion' => 'getSonata_Costos_Admin_TipoContratacionService',
            'sonata.costos.admin.tipo_control' => 'getSonata_Costos_Admin_TipoControlService',
            'sonata.costos.admin.tipo_dato' => 'getSonata_Costos_Admin_TipoDatoService',
            'sonata.costos.admin.tipo_recurso' => 'getSonata_Costos_Admin_TipoRecursoService',
            'sonata.costos.admin.ubicacion' => 'getSonata_Costos_Admin_UbicacionService',
            'sonata.costos.admin.up' => 'getSonata_Costos_Admin_UpService',
            'sonata.costos.periodos.ingreso' => 'getSonata_Costos_Periodos_IngresoService',
            'sonata.costos.periodos.ingreso.datos.formulario' => 'getSonata_Costos_Periodos_Ingreso_Datos_FormularioService',
            ...
            'vitacora.siig' => 'getVitacora_SiigService',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('my_listener', 'MINSAL\\IndicadoresBundle\\Listener\\LocaleListener');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/vendor/sonata-project/user-bundle/Resources/config/doctrine') => 'Sonata\\UserBundle\\Entity', ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/doctrine') => 'FOS\\UserBundle\\Entity'));
        $b->setGlobalBasename('mapping');

        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Application/Sonata/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/MINSAL/IndicadoresBundle/Entity'), 2 => ($this->targetDirs[3].'/src/MINSAL/CostosBundle/Entity')));
        ...
        $d->addDriver($c, 'MINSAL\\IndicadoresBundle\\Entity');
        $d->addDriver($c, 'MINSAL\\CostosBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('SonataUserBundle' => 'Sonata\\UserBundle\\Entity', 'ApplicationSonataUserBundle' => 'Application\\Sonata\\UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'IndicadoresBundle' => 'MINSAL\\IndicadoresBundle\\Entity', 'CostosBundle' => 'MINSAL\\CostosBundle\\Entity'));
        $e->setMetadataCacheImpl($this->get('doctrine.orm.default_metadata_cache'));
        $e->setQueryCacheImpl($this->get('doctrine.orm.default_query_cache'));
        $e->setResultCacheImpl($this->get('doctrine.orm.default_result_cache'));
    ...
    {
        $this->services['doctrine.orm.default_metadata_cache'] = $instance = new \Snc\RedisBundle\Doctrine\Cache\RedisCache();
    ...
    {
        $this->services['doctrine.orm.default_query_cache'] = $instance = new \Snc\RedisBundle\Doctrine\Cache\RedisCache();
    ...
    /**
     * Gets the 'doctrine.orm.read_result_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        $this->services['doctrine.orm.read_result_cache'] = $instance = new \Snc\RedisBundle\Doctrine\Cache\RedisCache();
    ...
    {
        return $this->services['fos_js_routing.extractor'] = new \FOS\JsRoutingBundle\Extractor\ExposedRoutesExtractor($this->get('router'), array(), __DIR__, array('FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle', 'SecurityBundle' => 'Symfony\\Bundle\\SecurityBundle\\SecurityBundle', 'TwigBundle' => 'Symfony\\Bundle\\TwigBundle\\TwigBundle', 'MonologBundle' => 'Symfony\\Bundle\\MonologBundle\\MonologBundle', 'SwiftmailerBundle' => 'Symfony\\Bundle\\SwiftmailerBundle\\SwiftmailerBundle', 'AsseticBundle' => 'Symfony\\Bundle\\AsseticBundle\\AsseticBundle', 'DoctrineBundle' => 'Doctrine\\Bundle\\DoctrineBundle\\DoctrineBundle', 'DoctrineFixturesBundle' => 'Doctrine\\Bundle\\FixturesBundle\\DoctrineFixturesBundle', 'SensioFrameworkExtraBundle' => 'Sensio\\Bundle\\FrameworkExtraBundle\\SensioFrameworkExtraBundle', 'SonataBlockBundle' => 'Sonata\\BlockBundle\\SonataBlockBundle', 'SonataCoreBundle' => 'Sonata\\CoreBundle\\SonataCoreBundle', 'SonataCacheBundle' => 'Sonata\\CacheBundle\\SonataCacheBundle', 'SonataAdminBundle' => 'Sonata\\AdminBundle\\SonataAdminBundle', 'SonataDoctrineORMAdminBundle' => 'Sonata\\DoctrineORMAdminBundle\\SonataDoctrineORMAdminBundle', 'SonataEasyExtendsBundle' => 'Sonata\\EasyExtendsBundle\\SonataEasyExtendsBundle', 'SonataUserBundle' => 'Sonata\\UserBundle\\SonataUserBundle', 'ApplicationSonataUserBundle' => 'Application\\Sonata\\UserBundle\\ApplicationSonataUserBundle', 'KnpMenuBundle' => 'Knp\\Bundle\\MenuBundle\\KnpMenuBundle', 'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle', 'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle', 'OldSoundRabbitMqBundle' => 'OldSound\\RabbitMqBundle\\OldSoundRabbitMqBundle', 'KnpSnappyBundle' => 'Knp\\Bundle\\SnappyBundle\\KnpSnappyBundle', 'MobileDetectBundle' => 'SunCat\\MobileDetectBundle\\MobileDetectBundle', 'IndicadoresBundle' => 'MINSAL\\IndicadoresBundle\\IndicadoresBundle', 'CostosBundle' => 'MINSAL\\CostosBundle\\CostosBundle', 'FOSRestBundle' => 'FOS\\RestBundle\\FOSRestBundle', 'JMSSerializerBundle' => 'JMS\\SerializerBundle\\JMSSerializerBundle', 'SncRedisBundle' => 'Snc\\RedisBundle\\SncRedisBundle', 'WebProfilerBundle' => 'Symfony\\Bundle\\WebProfilerBundle\\WebProfilerBundle', 'SensioDistributionBundle' => 'Sensio\\Bundle\\DistributionBundle\\SensioDistributionBundle', 'SensioGeneratorBundle' => 'Sensio\\Bundle\\GeneratorBundle\\SensioGeneratorBundle'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('MINSAL\\IndicadoresBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('MINSAL\\IndicadoresBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('fos_user.entity_manager'), 'MINSAL\\IndicadoresBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'indicadores.cargar_origen_datos_servicio' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MINSAL\IndicadoresBundle\Consumer\CargarOrigenDatoConsumer A MINSAL\IndicadoresBundle\Consumer\CargarOrigenDatoConsumer instance.
     */
    protected function getIndicadores_CargarOrigenDatosServicioService()
    {
        return $this->services['indicadores.cargar_origen_datos_servicio'] = new \MINSAL\IndicadoresBundle\Consumer\CargarOrigenDatoConsumer($this);
    }

    /**
     * Gets the 'indicadores.guardar_registro_origen_dato' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MINSAL\IndicadoresBundle\Consumer\GuardarRegistroOrigenDatoConsumer A MINSAL\IndicadoresBundle\Consumer\GuardarRegistroOrigenDatoConsumer instance.
     */
    protected function getIndicadores_GuardarRegistroOrigenDatoService()
    {
        return $this->services['indicadores.guardar_registro_origen_dato'] = new \MINSAL\IndicadoresBundle\Consumer\GuardarRegistroOrigenDatoConsumer($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'/vendor/symfony/assetic-bundle/Symfony/Bundle/AsseticBundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/config/serializer'), 'Doctrine\\Bundle\\FixturesBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-fixtures-bundle/Doctrine/Bundle/FixturesBundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Sensio/Bundle/FrameworkExtraBundle/Resources/config/serializer'), 'Sonata\\BlockBundle' => ($this->targetDirs[3].'/vendor/sonata-project/block-bundle/Resources/config/serializer'), 'Sonata\\CoreBundle' => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/config/serializer'), 'Sonata\\CacheBundle' => ($this->targetDirs[3].'/vendor/sonata-project/cache-bundle/Resources/config/serializer'), 'Sonata\\AdminBundle' => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/config/serializer'), 'Sonata\\DoctrineORMAdminBundle' => ($this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Resources/config/serializer'), 'Sonata\\EasyExtendsBundle' => ($this->targetDirs[3].'/vendor/sonata-project/easy-extends-bundle/Resources/config/serializer'), 'Sonata\\UserBundle' => ($this->targetDirs[3].'/vendor/sonata-project/user-bundle/Resources/config/serializer'), 'Application\\Sonata\\UserBundle' => ($this->targetDirs[3].'/src/Application/Sonata/UserBundle/Resources/config/serializer'), 'Knp\\Bundle\\MenuBundle' => ($this->targetDirs[3].'/vendor/knplabs/knp-menu-bundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/serializer'), 'FOS\\JsRoutingBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/jsrouting-bundle/FOS/JsRoutingBundle/Resources/config/serializer'), 'OldSound\\RabbitMqBundle' => ($this->targetDirs[3].'/vendor/oldsound/rabbitmq-bundle/OldSound/RabbitMqBundle/Resources/config/serializer'), 'Knp\\Bundle\\SnappyBundle' => ($this->targetDirs[3].'/vendor/knplabs/knp-snappy-bundle/Knp/Bundle/SnappyBundle/Resources/config/serializer'), 'SunCat\\MobileDetectBundle' => ($this->targetDirs[3].'/vendor/suncat/mobile-detect-bundle/SunCat/MobileDetectBundle/Resources/config/serializer'), 'MINSAL\\IndicadoresBundle' => ($this->targetDirs[3].'/src/MINSAL/IndicadoresBundle/Resources/config/serializer'), 'MINSAL\\CostosBundle' => ($this->targetDirs[3].'/src/MINSAL/CostosBundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Snc\\RedisBundle' => ($this->targetDirs[3].'/vendor/snc/redis-bundle/Snc/RedisBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer')));
    ...
    {
        return $this->services['mobile_detect.twig.extension'] = new \SunCat\MobileDetectBundle\Twig\Extension\MobileDetectExtension($this->get('mobile_detect.mobile_detector.default'), $this->get('mobile_detect.device_view'));
    }
    ...
    /**
     * Gets the 'monolog.processor.siig' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MINSAL\IndicadoresBundle\FormatoVitacora A MINSAL\IndicadoresBundle\FormatoVitacora instance.
     */
    protected function getMonolog_Processor_SiigService()
    {
        return $this->services['monolog.processor.siig'] = new \MINSAL\IndicadoresBundle\FormatoVitacora($this);
    }

    /**
     * Gets the 'my_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MINSAL\IndicadoresBundle\Listener\LocaleListener A MINSAL\IndicadoresBundle\Listener\LocaleListener instance.
     */
    protected function getMyListenerService()
    {
        return $this->services['my_listener'] = new \MINSAL\IndicadoresBundle\Listener\LocaleListener('es_SV');
    }

    /**
     * Gets the 'old_sound_rabbit_mq.cargar_origen_datos_consumer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getOldSoundRabbitMq_CargarOrigenDatosConsumerService()
    {
        $this->services['old_sound_rabbit_mq.cargar_origen_datos_consumer'] = $instance = new \OldSound\RabbitMqBundle\RabbitMq\Consumer($this->get('old_sound_rabbit_mq.connection.default'));

        $instance->setExchangeOptions(array('name' => 'cargar_origen_datos', 'type' => 'direct', 'passive' => false, 'durable' => true, 'auto_delete' => false, 'internal' => false, 'nowait' => false, 'declare' => true, 'arguments' => NULL, 'ticket' => NULL));
        $instance->setQueueOptions(array('name' => 'cargar_origen_datos', 'passive' => false, 'durable' => true, 'exclusive' => false, 'auto_delete' => false, 'nowait' => false, 'arguments' => NULL, 'ticket' => NULL, 'routing_keys' => array()));
        $instance->setCallback(array(0 => $this->get('indicadores.cargar_origen_datos_servicio'), 1 => 'execute'));

        return $instance;
    }

    /**
     * Gets the 'old_sound_rabbit_mq.cargar_origen_datos_producer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getOldSoundRabbitMq_CargarOrigenDatosProducerService()
    {
        $this->services['old_sound_rabbit_mq.cargar_origen_datos_producer'] = $instance = new \OldSound\RabbitMqBundle\RabbitMq\Producer($this->get('old_sound_rabbit_mq.connection.default'));
    ...
    {
        return $this->services['old_sound_rabbit_mq.connection.default'] = new \PhpAmqpLib\Connection\AMQPConnection('localhost', 5672, 'guest', 'guest', '/');
    }
    ...
    /**
     * Gets the 'old_sound_rabbit_mq.guardar_registro_producer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OldSound\RabbitMqBundle\RabbitMq\Producer A OldSound\RabbitMqBundle\RabbitMq\Producer instance.
     */
    protected function getOldSoundRabbitMq_GuardarRegistroProducerService()
    {
        $this->services['old_sound_rabbit_mq.guardar_registro_producer'] = $instance = new \OldSound\RabbitMqBundle\RabbitMq\Producer($this->get('old_sound_rabbit_mq.connection.default'));
    ...
    {
        $a = $this->get('old_sound_rabbit_mq.cargar_origen_datos_producer');
        $b = $this->get('old_sound_rabbit_mq.guardar_registro_producer');
        $c = $this->get('old_sound_rabbit_mq.cargar_origen_datos_consumer');
        $d = $this->get('old_sound_rabbit_mq.guardar_registro_consumer');
    ...
    protected function getSecurity_Firewall_Map_Context_AdminService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, '/admin/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/admin/logout'));
        ...
        $h->setOptions(array('login_path' => '/admin/login', 'default_target_path' => '/admin/dashboard', 'use_referer' => true, 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path'));
        ...
        return $this->services['security.firewall.map.context.admin'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.context_listener.0'), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $e, $this->get('security.authentication.session_strategy'), $a, 'admin', $h, $i, array('use_forward' => false, 'check_path' => '/admin/login_check', 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $d, $f, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '55e45245a8657', $d, $e), 5 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($b, $this->get('security.user.provider.concrete.chain_provider'), $this->get('security.user_checker'), 'admin', $this->get('security.access.decision_manager'), $d, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $f), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $a, 'admin', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($c, $a, '/admin/login', false), NULL, NULL, $d));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        $g->addHandler($this->get('security.logout.handler.session'));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.context_listener.0'), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $e, $this->get('security.authentication.session_strategy'), $a, 'main', $h, $i, array('use_forward' => false, 'check_path' => '/admin/login_check', 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $d, $f, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '55e45245a8657', $d, $e), 5 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($b, $this->get('security.user.provider.concrete.chain_provider'), $this->get('security.user_checker'), 'main', $this->get('security.access.decision_manager'), $d, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $f), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $a, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($c, $a, '/admin/login', false), NULL, NULL, $d));
    }
    ...
    protected function getSncRedis_CacheService()
    {
        ...
        return $this->services['snc_redis.cache'] = new \Predis\Client(new \Predis\Connection\ConnectionParameters(array('read_write_timeout' => NULL, 'iterable_multibulk' => false, 'profile' => '2.4', 'prefix' => NULL, 'replication' => false, 'async_connect' => false, 'timeout' => 5, 'persistent' => false, 'exceptions' => true, 'logging' => true, 'alias' => 'cache', 'scheme' => 'tcp', 'host' => 'localhost', 'port' => 6379, 'database' => 1, 'password' => NULL, 'weight' => NULL)), new \Predis\Option\ClientOptions(array('read_write_timeout' => NULL, 'iterable_multibulk' => false, 'profile' => $a, 'prefix' => NULL, 'replication' => false, 'async_connect' => false, 'timeout' => 5, 'persistent' => false, 'exceptions' => true, 'connections' => $b)));
    }
    ...
    /**
     * Gets the 'sonata.admin.agencia' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\AgenciaAdmin A MINSAL\IndicadoresBundle\Admin\AgenciaAdmin instance.
     */
    protected function getSonata_Admin_AgenciaService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\AgenciaAdmin('sonata.admin.agencia', 'MINSAL\\IndicadoresBundle\\Entity\\Agencia', 'SonataAdminBundle:CRUD');

        $instance->setMaxPerPage(10);
        ...
        $instance->setFormTheme(array(0 => 'IndicadoresBundle:Form:form_admin_fields.html.twig'));
    ...
    {
        return $this->services['sonata.admin.builder.filter.factory'] = new \Sonata\AdminBundle\Filter\FilterFactory($this, array('doctrine_orm_string' => 'sonata.admin.orm.filter.type.string', 'doctrine_orm_boolean' => 'sonata.admin.orm.filter.type.boolean', 'doctrine_orm_callback' => 'sonata.admin.orm.filter.type.callback', 'doctrine_orm_choice' => 'sonata.admin.orm.filter.type.choice', 'doctrine_orm_model' => 'sonata.admin.orm.filter.type.model', 'doctrine_orm_model_autocomplete' => 'sonata.admin.orm.filter.type.model_autocomplete', 'doctrine_orm_number' => 'sonata.admin.orm.filter.type.number', 'doctrine_orm_date' => 'sonata.admin.orm.filter.type.date', 'doctrine_orm_date_range' => 'sonata.admin.orm.filter.type.date_range', 'doctrine_orm_datetime' => 'sonata.admin.orm.filter.type.datetime', 'doctrine_orm_time' => 'sonata.admin.orm.filter.type.time', 'doctrine_orm_datetime_range' => 'sonata.admin.orm.filter.type.datetime_range', 'doctrine_orm_class' => 'sonata.admin.orm.filter.type.class'));
    }
    ...
    /**
     * Gets the 'sonata.admin.campo_calculado' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\CampoAdmin A MINSAL\IndicadoresBundle\Admin\CampoAdmin instance.
     */
    protected function getSonata_Admin_CampoCalculadoService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\CampoAdmin('sonata.admin.campo_calculado', 'MINSAL\\IndicadoresBundle\\Entity\\Campo', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_campo_calculado_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.categoria_variable_captura' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\CategoriaVariableCapturaAdmin A MINSAL\IndicadoresBundle\Admin\CategoriaVariableCapturaAdmin instance.
     */
    protected function getSonata_Admin_CategoriaVariableCapturaService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\CategoriaVariableCapturaAdmin('sonata.admin.categoria_variable_captura', 'MINSAL\\IndicadoresBundle\\Entity\\CategoriaVariableCaptura', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_categoria_variable_captura_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.clasificacion_nivel' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\ClasificacionNivelAdmin A MINSAL\IndicadoresBundle\Admin\ClasificacionNivelAdmin instance.
     */
    protected function getSonata_Admin_ClasificacionNivelService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\ClasificacionNivelAdmin('sonata.admin.clasificacion_nivel', 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionNivel', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('clasificacion_nivel');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.clasificacion_privacidad' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\ClasificacionPrivacidadAdmin A MINSAL\IndicadoresBundle\Admin\ClasificacionPrivacidadAdmin instance.
     */
    protected function getSonata_Admin_ClasificacionPrivacidadService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\ClasificacionPrivacidadAdmin('sonata.admin.clasificacion_privacidad', 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionPrivacidad', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('clasificacion_privacidad');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.clasificacion_tecnica' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\ClasificacionTecnicaAdmin A MINSAL\IndicadoresBundle\Admin\ClasificacionTecnicaAdmin instance.
     */
    protected function getSonata_Admin_ClasificacionTecnicaService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\ClasificacionTecnicaAdmin('sonata.admin.clasificacion_tecnica', 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionTecnica', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('clasificacion_tecnica');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.clasificacion_uso' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\ClasificacionUsoAdmin A MINSAL\IndicadoresBundle\Admin\ClasificacionUsoAdmin instance.
     */
    protected function getSonata_Admin_ClasificacionUsoService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\ClasificacionUsoAdmin('sonata.admin.clasificacion_uso', 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionUso', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('clasificacion_uso');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.colores_alertas' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\AlertaAdmin A MINSAL\IndicadoresBundle\Admin\AlertaAdmin instance.
     */
    protected function getSonata_Admin_ColoresAlertasService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\AlertaAdmin('sonata.admin.colores_alertas', 'MINSAL\\IndicadoresBundle\\Entity\\Alerta', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_colores_alertas_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
     ...
     *
     * @return \MINSAL\IndicadoresBundle\Admin\ConexionAdmin A MINSAL\IndicadoresBundle\Admin\ConexionAdmin instance.
     */
    protected function getSonata_Admin_ConexionService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\ConexionAdmin('sonata.admin.conexion', 'MINSAL\\IndicadoresBundle\\Entity\\Conexion', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.diccionario' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\DiccionarioAdmin A MINSAL\IndicadoresBundle\Admin\DiccionarioAdmin instance.
     */
    protected function getSonata_Admin_DiccionarioService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\DiccionarioAdmin('sonata.admin.diccionario', 'MINSAL\\IndicadoresBundle\\Entity\\Diccionario', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('javascript.diccionario_transformacion');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.ficha' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\FichaTecnicaAdmin A MINSAL\IndicadoresBundle\Admin\FichaTecnicaAdmin instance.
     */
    protected function getSonata_Admin_FichaService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\FichaTecnicaAdmin('sonata.admin.ficha', 'MINSAL\\IndicadoresBundle\\Entity\\FichaTecnica', 'IndicadoresBundle:FichaTecnicaAdmin');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('ficha_tecnica');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.formulario' service.
     *
     * @return \MINSAL\CostosBundle\Admin\FormularioAdmin A MINSAL\CostosBundle\Admin\FormularioAdmin instance.
     */
    protected function getSonata_Admin_FormularioService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\FormularioAdmin('sonata.admin.formulario', 'MINSAL\\CostosBundle\\Entity\\Formulario', 'CostosBundle:FormularioAdmin');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_formulario_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.fuente_dato' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\FuenteDatoAdmin A MINSAL\IndicadoresBundle\Admin\FuenteDatoAdmin instance.
     */
    protected function getSonata_Admin_FuenteDatoService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\FuenteDatoAdmin('sonata.admin.fuente_dato', 'MINSAL\\IndicadoresBundle\\Entity\\FuenteDato', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('fuente_datos');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.imagen' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\ImagenAdmin A MINSAL\IndicadoresBundle\Admin\ImagenAdmin instance.
     */
    protected function getSonata_Admin_ImagenService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\ImagenAdmin('sonata.admin.imagen', 'MINSAL\\IndicadoresBundle\\Entity\\Imagen', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.indicador_alertas' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\IndicadorAlertasAdmin A MINSAL\IndicadoresBundle\Admin\IndicadorAlertasAdmin instance.
     */
    protected function getSonata_Admin_IndicadorAlertasService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\IndicadorAlertasAdmin('sonata.admin.indicador_alertas', 'MINSAL\\IndicadoresBundle\\Entity\\IndicadorAlertas', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('indicador_alertas');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
     ...
     * This method always returns the same instance of the service.
     *
     * @return \MINSAL\IndicadoresBundle\Menu\MenuBuilder A MINSAL\IndicadoresBundle\Menu\MenuBuilder instance.
     */
    protected function getSonata_Admin_MenuBuilderService()
    {
        $this->services['sonata.admin.menu_builder'] = $instance = new \MINSAL\IndicadoresBundle\Menu\MenuBuilder($this->get('sonata.admin.pool'), $this->get('knp_menu.factory'), $this->get('knp_menu.menu_provider'), $this->get('debug.event_dispatcher'), $this->get('security.context'));
    ...
    /**
     * Gets the 'sonata.admin.origen_dato' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\OrigenDatosAdmin A MINSAL\IndicadoresBundle\Admin\OrigenDatosAdmin instance.
     */
    protected function getSonata_Admin_OrigenDatoService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\OrigenDatosAdmin('sonata.admin.origen_dato', 'MINSAL\\IndicadoresBundle\\Entity\\OrigenDatos', 'IndicadoresBundle:OrigenDatosAdmin');
     ...
     *
     * @return \MINSAL\IndicadoresBundle\Filter\StringFilter A MINSAL\IndicadoresBundle\Filter\StringFilter instance.
     */
    protected function getSonata_Admin_Orm_Filter_Type_StringService()
    {
        return new \MINSAL\IndicadoresBundle\Filter\StringFilter();
    }
    ...
    {
        $this->services['sonata.admin.pool'] = $instance = new \Sonata\AdminBundle\Admin\Pool($this, ' ', '/bundles/indicadores/images/logo_salud.png', array('confirm_exit' => false, 'form_type' => 'horizontal', 'html5_validate' => true, 'use_select2' => true, 'use_icheck' => true, 'use_bootlint' => false, 'pager_links' => NULL, 'dropdown_number_groups_per_colums' => 2, 'title_mode' => 'both', 'javascripts' => array(0 => 'bundles/sonatacore/vendor/jquery/dist/jquery.min.js', 1 => 'bundles/sonataadmin/vendor/jquery.scrollTo/jquery.scrollTo.min.js', 2 => 'bundles/sonatacore/vendor/moment/min/moment.min.js', 3 => 'bundles/sonatacore/vendor/bootstrap/dist/js/bootstrap.min.js', 4 => 'bundles/sonatacore/vendor/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js', 5 => 'bundles/sonataadmin/vendor/jqueryui/ui/minified/jquery-ui.min.js', 6 => 'bundles/sonataadmin/vendor/jqueryui/ui/minified/i18n/jquery-ui-i18n.min.js', 7 => 'bundles/sonataadmin/vendor/jquery-form/jquery.form.js', 8 => 'bundles/sonataadmin/jquery/jquery.confirmExit.js', 9 => 'bundles/sonataadmin/vendor/x-editable/dist/bootstrap3-editable/js/bootstrap-editable.min.js', 10 => 'bundles/sonatacore/vendor/select2/select2.min.js', 11 => 'bundles/sonataadmin/vendor/admin-lte/dist/js/app.min.js', 12 => 'bundles/sonataadmin/vendor/iCheck/icheck.min.js', 13 => 'bundles/sonataadmin/vendor/slimScroll/jquery.slimscroll.min.js', 14 => 'bundles/sonataadmin/Admin.js', 15 => 'bundles/sonataadmin/treeview.js'), 'stylesheets' => array(0 => 'bundles/sonatacore/vendor/bootstrap/dist/css/bootstrap.min.css', 1 => 'bundles/sonatacore/vendor/components-font-awesome/css/font-awesome.min.css', 2 => 'bundles/sonatacore/vendor/ionicons/css/ionicons.min.css', 3 => 'bundles/sonataadmin/vendor/admin-lte/dist/css/AdminLTE.min.css', 4 => 'bundles/sonataadmin/vendor/admin-lte/dist/css/skins/skin-black.min.css', 5 => 'bundles/sonataadmin/vendor/iCheck/skins/flat/blue.css', 6 => 'bundles/sonatacore/vendor/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css', 7 => 'bundles/sonataadmin/vendor/jqueryui/themes/base/jquery-ui.css', 8 => 'bundles/sonatacore/vendor/select2/select2.css', 9 => 'bundles/sonatacore/vendor/select2-bootstrap-css/select2-bootstrap.min.css', 10 => 'bundles/sonataadmin/vendor/x-editable/dist/bootstrap3-editable/css/bootstrap-editable.css', 11 => 'bundles/sonataadmin/css/styles.css', 12 => 'bundles/sonataadmin/css/layout.css', 13 => 'bundles/sonataadmin/css/tree.css')), array());

        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig'));
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.agencia', 1 => 'sonata.admin.imagen', 2 => 'sonata.admin.responsable_dato', 3 => 'sonata.admin.fuente_dato', 4 => 'sonata.admin.responsable_indicador', 5 => 'sonata.admin.clasificacion_tecnica', 6 => 'sonata.admin.clasificacion_privacidad', 7 => 'sonata.admin.clasificacion_nivel', 8 => 'sonata.admin.clasificacion_uso', 9 => 'sonata.admin.significado_campo', 10 => 'sonata.admin.colores_alertas', 11 => 'sonata.admin.conexion', 12 => 'sonata.admin.origen_dato', 13 => 'sonata.admin.diccionario', 14 => 'sonata.admin.regla_transformacion', 15 => 'sonata.admin.campo_calculado', 16 => 'sonata.admin.categoria_variable_captura', 17 => 'sonata.admin.variable_captura', 18 => 'sonata.admin.variable', 19 => 'sonata.admin.ficha', 20 => 'sonata.admin.indicador_alertas', 21 => 'sonata.admin.sala_acciones', 22 => 'sonata.admin.formulario', 23 => 'sonata.costos.admin.campo', 24 => 'sonata.costos.admin.grupocolumnas', 25 => 'sonata.costos.admin.estructura', 26 => 'sonata.costos.admin.up', 27 => 'sonata.costos.admin.contratos_fijos', 28 => 'sonata.costos.admin.ubicacion', 29 => 'sonata.costos.periodos.ingreso', 30 => 'sonata.costos.periodos.ingreso.datos.formulario', 31 => 'sonata.costos.admin.formato', 32 => 'sonata.costos.admin.tipo_control', 33 => 'sonata.costos.admin.tipo_dato', 34 => 'sonata.costos.admin.alineacion', 35 => 'sonata.costos.admin.tipo_contratacion', 36 => 'sonata.costos.admin.tipo_recurso', 37 => 'sonata.costos.admin.especialidad', 38 => 'sonata.costos.admin.criterios_distribucion', 39 => 'sonata.costos.admin.categorias_contratos', 40 => 'sonata.user.admin.user', 41 => 'sonata.user.admin.group'));
        $instance->setAdminGroups(array('catalogos' => array('label' => 'catalogos', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => array('admin' => 'sonata.admin.agencia', 'label' => '', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'sonata.admin.imagen', 'label' => '', 'route' => '', 'route_params' => array()), 2 => array('admin' => 'sonata.admin.responsable_dato', 'label' => '', 'route' => '', 'route_params' => array()), 3 => array('admin' => 'sonata.admin.fuente_dato', 'label' => '', 'route' => '', 'route_params' => array()), 4 => array('admin' => 'sonata.admin.responsable_indicador', 'label' => '', 'route' => '', 'route_params' => array()), 5 => array('admin' => 'sonata.admin.clasificacion_tecnica', 'label' => '', 'route' => '', 'route_params' => array()), 6 => array('admin' => 'sonata.admin.clasificacion_privacidad', 'label' => '', 'route' => '', 'route_params' => array()), 7 => array('admin' => 'sonata.admin.clasificacion_nivel', 'label' => '', 'route' => '', 'route_params' => array()), 8 => array('admin' => 'sonata.admin.clasificacion_uso', 'label' => '', 'route' => '', 'route_params' => array()), 9 => array('admin' => 'sonata.admin.significado_campo', 'label' => '', 'route' => '', 'route_params' => array()), 10 => array('admin' => 'sonata.admin.colores_alertas', 'label' => '', 'route' => '', 'route_params' => array()), 11 => array('admin' => 'sonata.costos.admin.formato', 'label' => '', 'route' => '', 'route_params' => array()), 12 => array('admin' => 'sonata.costos.admin.tipo_control', 'label' => '', 'route' => '', 'route_params' => array()), 13 => array('admin' => 'sonata.costos.admin.tipo_dato', 'label' => '', 'route' => '', 'route_params' => array()), 14 => array('admin' => 'sonata.costos.admin.alineacion', 'label' => '', 'route' => '', 'route_params' => array()), 15 => array('admin' => 'sonata.costos.admin.tipo_contratacion', 'label' => '', 'route' => '', 'route_params' => array()), 16 => array('admin' => 'sonata.costos.admin.tipo_recurso', 'label' => '', 'route' => '', 'route_params' => array()), 17 => array('admin' => 'sonata.costos.admin.especialidad', 'label' => '', 'route' => '', 'route_params' => array()), 18 => array('admin' => 'sonata.costos.admin.criterios_distribucion', 'label' => '', 'route' => '', 'route_params' => array()), 19 => array('admin' => 'sonata.costos.admin.categorias_contratos', 'label' => '', 'route' => '', 'route_params' => array()))), 'origen_datos' => array('label' => 'origen_datos', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => array('admin' => 'sonata.admin.conexion', 'label' => '', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'sonata.admin.origen_dato', 'label' => '', 'route' => '', 'route_params' => array()), 2 => array('admin' => 'sonata.admin.diccionario', 'label' => '', 'route' => '', 'route_params' => array()), 3 => array('admin' => 'sonata.admin.regla_transformacion', 'label' => '', 'route' => '', 'route_params' => array()), 4 => array('admin' => 'sonata.admin.campo_calculado', 'label' => '', 'route' => '', 'route_params' => array()), 5 => array('admin' => 'sonata.admin.categoria_variable_captura', 'label' => '', 'route' => '', 'route_params' => array()), 6 => array('admin' => 'sonata.admin.variable_captura', 'label' => '', 'route' => '', 'route_params' => array()))), 'indicadores' => array('label' => 'indicadores', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => array('admin' => 'sonata.admin.variable', 'label' => '', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'sonata.admin.ficha', 'label' => '', 'route' => '', 'route_params' => array()), 2 => array('admin' => 'sonata.admin.indicador_alertas', 'label' => '', 'route' => '', 'route_params' => array()), 3 => array('admin' => 'sonata.admin.sala_acciones', 'label' => '', 'route' => '', 'route_params' => array()))), '_configuracion_' => array('label' => '_configuracion_', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => array('admin' => 'sonata.admin.formulario', 'label' => '', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'sonata.costos.admin.campo', 'label' => '', 'route' => '', 'route_params' => array()), 2 => array('admin' => 'sonata.costos.admin.grupocolumnas', 'label' => '', 'route' => '', 'route_params' => array()), 3 => array('admin' => 'sonata.costos.admin.up', 'label' => '', 'route' => '', 'route_params' => array()), 4 => array('admin' => 'sonata.costos.admin.contratos_fijos', 'label' => '', 'route' => '', 'route_params' => array()), 5 => array('admin' => 'sonata.costos.admin.ubicacion', 'label' => '', 'route' => '', 'route_params' => array()), 6 => array('admin' => 'sonata.costos.periodos.ingreso', 'label' => '', 'route' => '', 'route_params' => array()), 7 => array('admin' => 'sonata.costos.periodos.ingreso.datos.formulario', 'label' => '', 'route' => '', 'route_params' => array()))), '_costeo_' => array('label' => '_costeo_', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => array('admin' => 'sonata.costos.admin.estructura', 'label' => '', 'route' => '', 'route_params' => array()))), 'sonata_user' => array('label' => 'sonata_user', 'label_catalogue' => 'SonataUserBundle', 'icon' => '<i class=\'fa fa-users\'></i>', 'roles' => array(), 'items' => array(0 => array('admin' => 'sonata.user.admin.user', 'label' => '', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'sonata.user.admin.group', 'label' => '', 'route' => '', 'route_params' => array())))));
        $instance->setAdminClasses(array('MINSAL\\IndicadoresBundle\\Entity\\Agencia' => array(0 => 'sonata.admin.agencia'), 'MINSAL\\IndicadoresBundle\\Entity\\Imagen' => array(0 => 'sonata.admin.imagen'), 'MINSAL\\IndicadoresBundle\\Entity\\ResponsableDato' => array(0 => 'sonata.admin.responsable_dato'), 'MINSAL\\IndicadoresBundle\\Entity\\FuenteDato' => array(0 => 'sonata.admin.fuente_dato'), 'MINSAL\\IndicadoresBundle\\Entity\\ResponsableIndicador' => array(0 => 'sonata.admin.responsable_indicador'), 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionTecnica' => array(0 => 'sonata.admin.clasificacion_tecnica'), 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionPrivacidad' => array(0 => 'sonata.admin.clasificacion_privacidad'), 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionNivel' => array(0 => 'sonata.admin.clasificacion_nivel'), 'MINSAL\\IndicadoresBundle\\Entity\\ClasificacionUso' => array(0 => 'sonata.admin.clasificacion_uso'), 'MINSAL\\IndicadoresBundle\\Entity\\SignificadoCampo' => array(0 => 'sonata.admin.significado_campo'), 'MINSAL\\IndicadoresBundle\\Entity\\Alerta' => array(0 => 'sonata.admin.colores_alertas'), 'MINSAL\\IndicadoresBundle\\Entity\\Conexion' => array(0 => 'sonata.admin.conexion'), 'MINSAL\\IndicadoresBundle\\Entity\\OrigenDatos' => array(0 => 'sonata.admin.origen_dato'), 'MINSAL\\IndicadoresBundle\\Entity\\Diccionario' => array(0 => 'sonata.admin.diccionario'), 'MINSAL\\IndicadoresBundle\\Entity\\ReglaTransformacion' => array(0 => 'sonata.admin.regla_transformacion'), 'MINSAL\\IndicadoresBundle\\Entity\\Campo' => array(0 => 'sonata.admin.campo_calculado'), 'MINSAL\\IndicadoresBundle\\Entity\\CategoriaVariableCaptura' => array(0 => 'sonata.admin.categoria_variable_captura'), 'MINSAL\\IndicadoresBundle\\Entity\\VariableCaptura' => array(0 => 'sonata.admin.variable_captura'), 'MINSAL\\IndicadoresBundle\\Entity\\VariableDato' => array(0 => 'sonata.admin.variable'), 'MINSAL\\IndicadoresBundle\\Entity\\FichaTecnica' => array(0 => 'sonata.admin.ficha'), 'MINSAL\\IndicadoresBundle\\Entity\\IndicadorAlertas' => array(0 => 'sonata.admin.indicador_alertas'), 'MINSAL\\IndicadoresBundle\\Entity\\SalaAcciones' => array(0 => 'sonata.admin.sala_acciones'), 'MINSAL\\CostosBundle\\Entity\\Formulario' => array(0 => 'sonata.admin.formulario'), 'MINSAL\\CostosBundle\\Entity\\Campo' => array(0 => 'sonata.costos.admin.campo'), 'MINSAL\\CostosBundle\\Entity\\GrupoColumnas' => array(0 => 'sonata.costos.admin.grupocolumnas'), 'MINSAL\\CostosBundle\\Entity\\Estructura' => array(0 => 'sonata.costos.admin.estructura'), 'MINSAL\\CostosBundle\\Entity\\UnidadesProductivas' => array(0 => 'sonata.costos.admin.up'), 'MINSAL\\CostosBundle\\Entity\\ContratosFijosGA' => array(0 => 'sonata.costos.admin.contratos_fijos'), 'MINSAL\\CostosBundle\\Entity\\Ubicacion' => array(0 => 'sonata.costos.admin.ubicacion'), 'MINSAL\\CostosBundle\\Entity\\PeriodoIngreso' => array(0 => 'sonata.costos.periodos.ingreso'), 'MINSAL\\CostosBundle\\Entity\\PeriodoIngresoDatosFormulario' => array(0 => 'sonata.costos.periodos.ingreso.datos.formulario'), 'MINSAL\\CostosBundle\\Entity\\Formato' => array(0 => 'sonata.costos.admin.formato'), 'MINSAL\\CostosBundle\\Entity\\TipoControl' => array(0 => 'sonata.costos.admin.tipo_control'), 'MINSAL\\CostosBundle\\Entity\\TipoDato' => array(0 => 'sonata.costos.admin.tipo_dato'), 'MINSAL\\CostosBundle\\Entity\\Alineacion' => array(0 => 'sonata.costos.admin.alineacion'), 'MINSAL\\CostosBundle\\Entity\\TipoContratacion' => array(0 => 'sonata.costos.admin.tipo_contratacion'), 'MINSAL\\CostosBundle\\Entity\\TipoRecurso' => array(0 => 'sonata.costos.admin.tipo_recurso'), 'MINSAL\\CostosBundle\\Entity\\Especialidad' => array(0 => 'sonata.costos.admin.especialidad'), 'MINSAL\\CostosBundle\\Entity\\CriteriosDistribucionGA' => array(0 => 'sonata.costos.admin.criterios_distribucion'), 'MINSAL\\CostosBundle\\Entity\\CategoriasContratosFijosGA' => array(0 => 'sonata.costos.admin.categorias_contratos'), 'MINSAL\\IndicadoresBundle\\Entity\\User' => array(0 => 'sonata.user.admin.user'), 'Application\\Sonata\\UserBundle\\Entity\\Group' => array(0 => 'sonata.user.admin.group')));

        return $instance;
    }

    /**
     * Gets the 'sonata.admin.regla_transformacion' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\ReglaTransformacionAdmin A MINSAL\IndicadoresBundle\Admin\ReglaTransformacionAdmin instance.
     */
    protected function getSonata_Admin_ReglaTransformacionService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\ReglaTransformacionAdmin('sonata.admin.regla_transformacion', 'MINSAL\\IndicadoresBundle\\Entity\\ReglaTransformacion', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_regla_transformacion_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.responsable_dato' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\ResponsableDatoAdmin A MINSAL\IndicadoresBundle\Admin\ResponsableDatoAdmin instance.
     */
    protected function getSonata_Admin_ResponsableDatoService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\ResponsableDatoAdmin('sonata.admin.responsable_dato', 'MINSAL\\IndicadoresBundle\\Entity\\ResponsableDato', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('responsable_datos');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.responsable_indicador' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\ResponsableIndicadorAdmin A MINSAL\IndicadoresBundle\Admin\ResponsableIndicadorAdmin instance.
     */
    protected function getSonata_Admin_ResponsableIndicadorService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\ResponsableIndicadorAdmin('sonata.admin.responsable_indicador', 'MINSAL\\IndicadoresBundle\\Entity\\ResponsableIndicador', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('responsable_indicador');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.agencia', 1 => 'sonata.admin.imagen', 2 => 'sonata.admin.responsable_dato', 3 => 'sonata.admin.fuente_dato', 4 => 'sonata.admin.responsable_indicador', 5 => 'sonata.admin.clasificacion_tecnica', 6 => 'sonata.admin.clasificacion_privacidad', 7 => 'sonata.admin.clasificacion_nivel', 8 => 'sonata.admin.clasificacion_uso', 9 => 'sonata.admin.significado_campo', 10 => 'sonata.admin.colores_alertas', 11 => 'sonata.admin.conexion', 12 => 'sonata.admin.origen_dato', 13 => 'sonata.admin.diccionario', 14 => 'sonata.admin.regla_transformacion', 15 => 'sonata.admin.campo_calculado', 16 => 'sonata.admin.categoria_variable_captura', 17 => 'sonata.admin.variable_captura', 18 => 'sonata.admin.variable', 19 => 'sonata.admin.ficha', 20 => 'sonata.admin.indicador_alertas', 21 => 'sonata.admin.sala_acciones', 22 => 'sonata.admin.formulario', 23 => 'sonata.costos.admin.campo', 24 => 'sonata.costos.admin.grupocolumnas', 25 => 'sonata.costos.admin.estructura', 26 => 'sonata.costos.admin.up', 27 => 'sonata.costos.admin.contratos_fijos', 28 => 'sonata.costos.admin.ubicacion', 29 => 'sonata.costos.periodos.ingreso', 30 => 'sonata.costos.periodos.ingreso.datos.formulario', 31 => 'sonata.costos.admin.formato', 32 => 'sonata.costos.admin.tipo_control', 33 => 'sonata.costos.admin.tipo_dato', 34 => 'sonata.costos.admin.alineacion', 35 => 'sonata.costos.admin.tipo_contratacion', 36 => 'sonata.costos.admin.tipo_recurso', 37 => 'sonata.costos.admin.especialidad', 38 => 'sonata.costos.admin.criterios_distribucion', 39 => 'sonata.costos.admin.categorias_contratos', 40 => 'sonata.user.admin.user', 41 => 'sonata.user.admin.group'), $this);
    }

    /**
     * Gets the 'sonata.admin.sala_acciones' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\SalaAccionesAdmin A MINSAL\IndicadoresBundle\Admin\SalaAccionesAdmin instance.
     */
    protected function getSonata_Admin_SalaAccionesService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\SalaAccionesAdmin('sonata.admin.sala_acciones', 'MINSAL\\IndicadoresBundle\\Entity\\SalaAcciones', 'IndicadoresBundle:SalaAccionesAdmin');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_sala_acciones_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.significado_campo' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\SignificadoCampoAdmin A MINSAL\IndicadoresBundle\Admin\SignificadoCampoAdmin instance.
     */
    protected function getSonata_Admin_SignificadoCampoService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\SignificadoCampoAdmin('sonata.admin.significado_campo', 'MINSAL\\IndicadoresBundle\\Entity\\SignificadoCampo', 'IndicadoresBundle:SignificadoCampoAdmin');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('significado_campo');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.variable' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\VariableDatoAdmin A MINSAL\IndicadoresBundle\Admin\VariableDatoAdmin instance.
     */
    protected function getSonata_Admin_VariableService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\VariableDatoAdmin('sonata.admin.variable', 'MINSAL\\IndicadoresBundle\\Entity\\VariableDato', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.variable_captura' service.
     *
     * @return \MINSAL\IndicadoresBundle\Admin\VariableCapturaAdmin A MINSAL\IndicadoresBundle\Admin\VariableCapturaAdmin instance.
     */
    protected function getSonata_Admin_VariableCapturaService()
    {
        $instance = new \MINSAL\IndicadoresBundle\Admin\VariableCapturaAdmin('sonata.admin.variable_captura', 'MINSAL\\IndicadoresBundle\\Entity\\VariableCaptura', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_variable_captura_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    {
        return $this->services['sonata.cache.apc'] = new \Sonata\CacheBundle\Adapter\ApcCache($this->get('router'), 's3cur3', 'test', array(0 => array('domain' => 'kooqit.local', 'ip' => '127.0.0.1', 'port' => 80, 'basic' => false)), array('RCV' => array(), 'SND' => array()));
    }
    ...
    {
        return $this->services['sonata.core.twig.extension.wrapping'] = new \Sonata\CoreBundle\Twig\Extension\FormTypeExtension('horizontal');
    }
    ...
    /**
     * Gets the 'sonata.costos.admin.alineacion' service.
     *
     * @return \MINSAL\CostosBundle\Admin\AlineacionAdmin A MINSAL\CostosBundle\Admin\AlineacionAdmin instance.
     */
    protected function getSonata_Costos_Admin_AlineacionService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\AlineacionAdmin('sonata.costos.admin.alineacion', 'MINSAL\\CostosBundle\\Entity\\Alineacion', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_alineacion_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.costos.admin.campo' service.
     *
     * @return \MINSAL\CostosBundle\Admin\CampoAdmin A MINSAL\CostosBundle\Admin\CampoAdmin instance.
     */
    protected function getSonata_Costos_Admin_CampoService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\CampoAdmin('sonata.costos.admin.campo', 'MINSAL\\CostosBundle\\Entity\\Campo', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.costos.admin.categorias_contratos' service.
     *
     * @return \MINSAL\CostosBundle\Admin\CategoriasContratosFijosGAAdmin A MINSAL\CostosBundle\Admin\CategoriasContratosFijosGAAdmin instance.
     */
    protected function getSonata_Costos_Admin_CategoriasContratosService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\CategoriasContratosFijosGAAdmin('sonata.costos.admin.categorias_contratos', 'MINSAL\\CostosBundle\\Entity\\CategoriasContratosFijosGA', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_categorias_contratos_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.costos.admin.contratos_fijos' service.
     *
     * @return \MINSAL\CostosBundle\Admin\ContratosFijosGAAdmin A MINSAL\CostosBundle\Admin\ContratosFijosGAAdmin instance.
     */
    protected function getSonata_Costos_Admin_ContratosFijosService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\ContratosFijosGAAdmin('sonata.costos.admin.contratos_fijos', 'MINSAL\\CostosBundle\\Entity\\ContratosFijosGA', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_contratos_fijos_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.costos.admin.criterios_distribucion' service.
     *
     * @return \MINSAL\CostosBundle\Admin\CriteriosDistribucionGAAdmin A MINSAL\CostosBundle\Admin\CriteriosDistribucionGAAdmin instance.
     */
    protected function getSonata_Costos_Admin_CriteriosDistribucionService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\CriteriosDistribucionGAAdmin('sonata.costos.admin.criterios_distribucion', 'MINSAL\\CostosBundle\\Entity\\CriteriosDistribucionGA', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_criterios_distribucion_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.costos.admin.especialidad' service.
     *
     * @return \MINSAL\CostosBundle\Admin\EspecialidadAdmin A MINSAL\CostosBundle\Admin\EspecialidadAdmin instance.
     */
    protected function getSonata_Costos_Admin_EspecialidadService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\EspecialidadAdmin('sonata.costos.admin.especialidad', 'MINSAL\\CostosBundle\\Entity\\Especialidad', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_especialidad_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.costos.admin.estructura' service.
     *
     * @return \MINSAL\CostosBundle\Admin\EstructuraAdmin A MINSAL\CostosBundle\Admin\EstructuraAdmin instance.
     */
    protected function getSonata_Costos_Admin_EstructuraService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\EstructuraAdmin('sonata.costos.admin.estructura', 'MINSAL\\CostosBundle\\Entity\\Estructura', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_estructura_organizativa_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.costos.admin.formato' service.
     *
     * @return \MINSAL\CostosBundle\Admin\FormatoAdmin A MINSAL\CostosBundle\Admin\FormatoAdmin instance.
     */
    protected function getSonata_Costos_Admin_FormatoService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\FormatoAdmin('sonata.costos.admin.formato', 'MINSAL\\CostosBundle\\Entity\\Formato', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.costos.admin.grupocolumnas' service.
     *
     * @return \MINSAL\CostosBundle\Admin\GrupoColumnasAdmin A MINSAL\CostosBundle\Admin\GrupoColumnasAdmin instance.
     */
    protected function getSonata_Costos_Admin_GrupocolumnasService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\GrupoColumnasAdmin('sonata.costos.admin.grupocolumnas', 'MINSAL\\CostosBundle\\Entity\\GrupoColumnas', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_grupo_columnas_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.costos.admin.tipo_contratacion' service.
     *
     * @return \MINSAL\CostosBundle\Admin\TipoContratacionAdmin A MINSAL\CostosBundle\Admin\TipoContratacionAdmin instance.
     */
    protected function getSonata_Costos_Admin_TipoContratacionService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\TipoContratacionAdmin('sonata.costos.admin.tipo_contratacion', 'MINSAL\\CostosBundle\\Entity\\TipoContratacion', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_tipo_contratacion_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.costos.admin.tipo_control' service.
     *
     * @return \MINSAL\CostosBundle\Admin\TipoControlAdmin A MINSAL\CostosBundle\Admin\TipoControlAdmin instance.
     */
    protected function getSonata_Costos_Admin_TipoControlService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\TipoControlAdmin('sonata.costos.admin.tipo_control', 'MINSAL\\CostosBundle\\Entity\\TipoControl', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_tipo_control_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.costos.admin.tipo_dato' service.
     *
     * @return \MINSAL\CostosBundle\Admin\TipoDatoAdmin A MINSAL\CostosBundle\Admin\TipoDatoAdmin instance.
     */
    protected function getSonata_Costos_Admin_TipoDatoService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\TipoDatoAdmin('sonata.costos.admin.tipo_dato', 'MINSAL\\CostosBundle\\Entity\\TipoDato', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.costos.admin.tipo_recurso' service.
     *
     * @return \MINSAL\CostosBundle\Admin\TipoRecursoAdmin A MINSAL\CostosBundle\Admin\TipoRecursoAdmin instance.
     */
    protected function getSonata_Costos_Admin_TipoRecursoService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\TipoRecursoAdmin('sonata.costos.admin.tipo_recurso', 'MINSAL\\CostosBundle\\Entity\\TipoRecurso', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_tipo_recurso_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.costos.admin.ubicacion' service.
     *
     * @return \MINSAL\CostosBundle\Admin\UbicacionAdmin A MINSAL\CostosBundle\Admin\UbicacionAdmin instance.
     */
    protected function getSonata_Costos_Admin_UbicacionService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\UbicacionAdmin('sonata.costos.admin.ubicacion', 'MINSAL\\CostosBundle\\Entity\\Ubicacion', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.costos.admin.up' service.
     *
     * @return \MINSAL\CostosBundle\Admin\UnidadesProductivasAdmin A MINSAL\CostosBundle\Admin\UnidadesProductivasAdmin instance.
     */
    protected function getSonata_Costos_Admin_UpService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\UnidadesProductivasAdmin('sonata.costos.admin.up', 'MINSAL\\CostosBundle\\Entity\\UnidadesProductivas', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_unidades_productivas_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.costos.periodos.ingreso' service.
     *
     * @return \MINSAL\CostosBundle\Admin\PeriodoIngresoAdmin A MINSAL\CostosBundle\Admin\PeriodoIngresoAdmin instance.
     */
    protected function getSonata_Costos_Periodos_IngresoService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\PeriodoIngresoAdmin('sonata.costos.periodos.ingreso', 'MINSAL\\CostosBundle\\Entity\\PeriodoIngreso', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_periodo_ingreso_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.costos.periodos.ingreso.datos.formulario' service.
     *
     * @return \MINSAL\CostosBundle\Admin\PeriodoIngresoDatosFormularioAdmin A MINSAL\CostosBundle\Admin\PeriodoIngresoDatosFormularioAdmin instance.
     */
    protected function getSonata_Costos_Periodos_Ingreso_Datos_FormularioService()
    {
        $instance = new \MINSAL\CostosBundle\Admin\PeriodoIngresoDatosFormularioAdmin('sonata.costos.periodos.ingreso.datos.formulario', 'MINSAL\\CostosBundle\\Entity\\PeriodoIngresoDatosFormulario', 'SonataAdminBundle:CRUD');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('_periodo_ingreso_datos_formulario_');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'IndicadoresBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'IndicadoresBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'IndicadoresBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'IndicadoresBundle:Menu:main_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    protected function getSonata_EasyExtends_Doctrine_MapperService()
    {
        ...
        $instance->addAssociation('MINSAL\\IndicadoresBundle\\Entity\\User', 'mapManyToMany', array(0 => array('fieldName' => 'groups', 'targetEntity' => 'Application\\Sonata\\UserBundle\\Entity\\Group', 'cascade' => array(), 'joinTable' => array('name' => 'fos_user_user_group', 'joinColumns' => array(0 => array('name' => 'user_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'inverseJoinColumns' => array(0 => array('name' => 'group_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE'))))));
     ...
     *
     * @return \Application\Sonata\UserBundle\Admin\Entity\GroupAdmin A Application\Sonata\UserBundle\Admin\Entity\GroupAdmin instance.
     */
    protected function getSonata_User_Admin_GroupService()
    {
        $instance = new \Application\Sonata\UserBundle\Admin\Entity\GroupAdmin('sonata.user.admin.group', 'Application\\Sonata\\UserBundle\\Entity\\Group', 'SonataAdminBundle:CRUD');
    ...
    {
        $instance = new \Application\Sonata\UserBundle\Admin\Entity\UserAdmin('sonata.user.admin.user', 'MINSAL\\IndicadoresBundle\\Entity\\User', 'SonataAdminBundle:CRUD');
    ...
    {
        return $this->services['sonata.user.editable_role_builder'] = new \Sonata\UserBundle\Security\EditableRolesBuilder($this->get('security.context'), $this->get('sonata.admin.pool'), array('ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_SONATA_ADMIN', 2 => 'ROLE_USER_TABLERO', 3 => 'ROLE_USER_PIVOT_TABLE', 4 => 'ROLE_USER_CAPTURA_DATOS', 5 => 'ROLE_USER_COSTEO', 6 => 'ROLE_USER_REPORTES'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH'), 'SONATA' => array()));
    }
    ...
    {
        return $this->services['sonata.user.form.gender_list'] = new \Sonata\CoreBundle\Form\Type\StatusType('MINSAL\\IndicadoresBundle\\Entity\\User', 'getGenderList', 'sonata_user_gender');
    }
    ...
    {
        return $this->services['sonata.user.profile.form.type'] = new \Sonata\UserBundle\Form\Type\ProfileType('MINSAL\\IndicadoresBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['sonata.user.registration.form.type'] = new \Sonata\UserBundle\Form\Type\RegistrationFormType('MINSAL\\IndicadoresBundle\\Entity\\User', array());
    }
    ...
    protected function getSonata_User_UserManagerService()
    {
        ...
        return $this->services['sonata.user.user_manager'] = new \Sonata\UserBundle\Entity\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('fos_user.entity_manager'), 'MINSAL\\IndicadoresBundle\\Entity\\User');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'/src/MINSAL/IndicadoresBundle/Resources/translations/messages.en.yml'), 'en', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/MINSAL/IndicadoresBundle/Resources/translations/messages.es.yml'), 'es', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/MINSAL/CostosBundle/Resources/translations/messages.en.yml'), 'en', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/MINSAL/CostosBundle/Resources/translations/messages.es.yml'), 'es', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views'), 'Swiftmailer');
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/oldsound/rabbitmq-bundle/OldSound/RabbitMqBundle/Resources/views'), 'OldSoundRabbitMq');
        $instance->addPath(($this->targetDirs[3].'/src/MINSAL/IndicadoresBundle/Resources/views'), 'Indicadores');
        $instance->addPath(($this->targetDirs[3].'/src/MINSAL/CostosBundle/Resources/views'), 'Costos');
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $b = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_SONATA_ADMIN', 2 => 'ROLE_USER_TABLERO', 3 => 'ROLE_USER_PIVOT_TABLE', 4 => 'ROLE_USER_CAPTURA_DATOS', 5 => 'ROLE_USER_COSTEO', 6 => 'ROLE_USER_REPORTES'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH'), 'SONATA' => array()));
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/rest-service'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'IndicadoresBundle' => 'MINSAL\\IndicadoresBundle\\IndicadoresBundle',
                'CostosBundle' => 'MINSAL\\CostosBundle\\CostosBundle',
            ...
            'database_path' => NULL,
            'archivo_vitacora' => ($this->targetDirs[2].'/logs/minsal.log'),
            'graficos_por_fila' => 3,
            'ancho_area_grafico' => 370,
            'alto_area_grafico' => 400,
            'titulo_sala_tamanio_fuente' => 12,
            'ocultar_menu_principal' => 0,
            'logo' => 1,
            'directorio' => '',
            'admin_max_per_page_number' => 10,
            'indicador_cache_consulta' => 3600,
            ...
            'security.role_hierarchy.roles' => array(
                'ROLE_ADMIN' => array(
                    ...
                    1 => 'ROLE_SONATA_ADMIN',
                    2 => 'ROLE_USER_TABLERO',
                    3 => 'ROLE_USER_PIVOT_TABLE',
                    4 => 'ROLE_USER_CAPTURA_DATOS',
                    5 => 'ROLE_USER_COSTEO',
                    6 => 'ROLE_USER_REPORTES',
                ),
            ...
            'sonata_doctrine_orm_admin.templates' => array(
                ...
                'form' => array(
                    0 => 'IndicadoresBundle:Form:form_admin_fields.html.twig',
                ),
                'filter' => array(
            ...
            'sonata.user.admin.user.entity' => 'MINSAL\\IndicadoresBundle\\Entity\\User',
            ...
            'fos_user.model.user.class' => 'MINSAL\\IndicadoresBundle\\Entity\\User',
