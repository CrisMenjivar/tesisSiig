...
class FichaTecnicaAdmin extends Admin
{
    ...
    protected function configureRoutes(RouteCollection $collection)
    {
		...
		//$collection->add('menu_reportes');
		$collection->add('reportes_crear', 'reportesCrear');
		//$collection->add('reportesIndicadores');
		//$collection->add('verSql', 'verSql/{id_fichaTecnica}');
	//$collection->add('generarReportePDF', 'generarReportePDF/{titulo}/{comentario}');
