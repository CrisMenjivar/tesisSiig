$(document).ready(function() {
	...
	var divBoton = document.getElementById('sala');
		var boton = '<A class="crear_reporte"> <button type="button" class="btn btn-success "> <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> Crear reporte </button></A>'; 
